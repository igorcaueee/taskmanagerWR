...
@else
    <div class="space-y-2">
        ...
        <div class="flex items-center justify-between bg-gray-50 border border-gray-100 rounded px-3 py-2.5">
            <div class="flex-1 min-w-0">
                ...
                <div class="flex flex-wrap items-center gap-x-3 gap-y-0.5 mt-0.5">
                    ...
                    @endif
                    @if($contato->gmail)
                        <span class="text-xs text-gray-500"><i class="fa-solid fa-envelope mr-1"></i>{{ $contato->gmail }}</span>
                    @endif
                </div>
            </div>
            @if(auth()->user()?->canEditarClientes())
