...
<head>
    ...
    <title>404 — Página não encontrada | WR Assessoria</title>
...
<div class="min-h-screen flex items-center justify-center py-16">
    <div class="w-full max-w-md text-center">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-xl shadow-sm border border-gray-200 dark:border-[#334155] p-10">
            ...
            <div class="text-7xl font-extrabold text-indigo-500 dark:text-indigo-400 mb-2">404</div>
            <h2 class="text-xl font-semibold text-gray-800 dark:text-slate-100 mb-2">Página não encontrada</h2>
