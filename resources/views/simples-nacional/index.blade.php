...
@section('content')
    <div class="max-w-7xl mx-auto py-6 px-4">
        ...
        <div id="cardImportarDominio" class="hidden bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-5 mb-6">
    ...
    const cardImportarDominio      = document.getElementById('cardImportarDominio');
    ...
    function atualizarVisibilidadeDeclaracoes(configurado) {
        ...
        cardImportarDominio.classList.toggle('hidden', !configurado);
    }
