...
@section('title', 'Transmitir DEFIS — Utilitários Fiscal')
...
@section('content')
    <div class="max-w-7xl mx-auto py-6 px-4">
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900 dark:text-slate-100 mt-1"><i class="fa-solid fa-paper-plane"></i> Transmitir DEFIS</h1>
            <p class="text-gray-700 dark:text-gray-300">Lançar os dados anuais e transmitir a DEFIS (declaração de informações socioeconômicas e fiscais).</p>
        </div>
