...
class ClienteController extends Controller
{
    ...
    public function saveCliente(Request $request): RedirectResponse
    {
        ...
        $data = $request->only(['nome', 'tipo', 'pasta_arquivos', 'segmentacao_id', 'atividade', 'descricao', 'cpfcnpj', 'regime_tributario', 'cidade', 'estado', 'fator_r', 'importar_notas_fiscais', 'pode_enviar_documentos', 'recebe_arquivos_portal', 'recebe_arquivos_email', 'recebe_arquivos_whatsapp', 'cliente_desde', 'dataabertura', 'vencimento_certificado', 'faturamento', 'servico', 'honorario']);
        $data['status'] = 'ativo';
